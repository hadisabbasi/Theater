...
import exception.TurnExistsException;

import java.util.Scanner;

public class Main {
    private static final ConferenceArray conferences = new ConferenceArray();
    private static final AccountArray accountArray = new AccountArray();
            ...
            while (number != 5) {
                if (number == 1) {
                    ...
                    if (conferenceTurn == null) {
                        ...
                        if (result == -1) System.out.println("ظرفیت خالی برای این هفته وجود ندارد.");
                        else System.out.println("رویداد جدید به برنامه ی این هفته اضافه شد. آیدی:" + result);
                    }
                    ...
                    if (result == -1) System.out.println("رویداد مورد نظر یافت نشد.");
                    else System.out.println("برنامه با ایدی" + id + "حذف شد");
                }
            }
        } catch (Exception e) {
